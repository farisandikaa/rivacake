                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="class__item">
                                <div class="class__item__pic set-bg" data-setbg="img/class/class-1.jpg">
                                    <!--<div class="label">Rp. 200.000</div> -->
                                </div>
                                <div class="class__item__text">
                                    <h5><a href="#">Private Class</a></h5>
                                    <p>1 on 1 </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="class__item">
                                <div class="class__item__pic set-bg" data-setbg="img/class/class-2.jpg">
                                    <!--<div class="label">Rp. 100.000</div> -->
                                </div>
                                <div class="class__item__text">
                                    <h5><a href="#">Reguler Class</a></h5>
...
<script>
  document.getElementById('KelasForm').addEventListener('submit', function(e) {
    ...
    const adminNumber = "6285779086772"; 

    let pesan = `Halo, saya ${nama} dengan nomor ${wa}, ingin daftar Kelas ${jenis}.`;
